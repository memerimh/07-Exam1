...
###############################################################################
# TO: 2.  READ the doc-string for the   product_of_digits   function below.
...
def run_test_problem1b():
    ...
    # -------------------------------------------------------------------------
    # TODOOO: 4. Implement at least 4 tests of the problem1b function.
    ...
    print('  Expected:', expected)
    print('  Actual:  ', answer)
    expected = (4 + 11 + 12 + 13 + 14 + 10)
    answer = problem1b(4)
    print()
    print('Test 1 is: problem1b(4)')
    print('  Expected:', expected)
    print('  Actual:  ', answer)
    expected = (5 + 11 + 12 + 13 + 14 + 15 + 21 + 22 + 10 + 20)
    answer = problem1b(5)
    print()
...
def problem1b(r):
    ...
    """
    # -------------------------------------------------------------------------
    # T: 5. Implement and test this function.
